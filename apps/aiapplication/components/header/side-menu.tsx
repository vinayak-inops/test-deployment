...
export default function SideMenu() {
  ...
  return (
    <div className="group fixed left-0 bottom-0 h-screen z-[5] w-2">
      <div className="absolute left-0 bottom-0 h-full w-full z-10" />

      <aside className="relative h-full w-12">
        <nav className="flex flex-col items-center justify-end h-full py-2 bg-blue-50">
          <button
