...
import { navMenu } from "@/json/menu/menu";
...
function DashboardWrapper({
  ...
  const filteredNavItems = useFilteredNavigation(navMenu, adminRole);
  useEffect(() => {
    setNavList(filteredNavItems)
  }, [ filteredNavItems, navMenu]);
    ...
    <div className="bg-white">
      ...
      <div className="flex flex-wrap">
        ...
        <motion.div
          ...
          className={`w-full pt-0 flex-wrap min-h-screen flex flex-col`}
        >
          <div className="flex flex-col min-h-screen relative shadow-[0_48px_100px_0_rgba(17,12,46,0.15)]">
            {navMenu?.length > 0 && (
              // <MainHeader navItems={navList}/>
              <Header navItems={navList} serviceName="AI Chat"/>
            )}
