...
import type { EwaTenantOutstandingRow } from "./hooks/useEwaTenantOutStandingLogic"
import {
  formatMonthYear,
  formatCurrency,
...
interface EwaTenantOutstandingTableProps {
  rows:           EwaTenantOutstandingRow[]
  loading:        boolean
...
function PaginationControls({
  ...
  EwaTenantOutstandingTableProps,
  | "totalCount"
  | "totalPages"
  | "safePage"
  | "startIndex"
...
export default function EwaTenantOutstandingTable({
  rows,
  loading,
  countLoading,
  totalCount,
    ...
    return (
      <div className="py-16 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          Loading EWA tenant outstanding records...
        </p>
      </div>
    )
  }
  ...
  if (rows.length === 0) {
    return (
      <div className="py-16 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          No EWA tenant outstanding records found
        </p>
      </div>
    )
  }
