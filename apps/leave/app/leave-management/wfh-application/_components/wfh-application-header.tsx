...
interface WfhApplicationHeaderProps {
  title?: string
  description?: string
  onRefilter?: () => void
  onAddNew?: () => void
...
function WfhApplicationHeader({
  title = "WFH Applications",
  description = "Manage and review work from home requests",
  onRefilter,
  onAddNew,
  canAdd = true,
}: WfhApplicationHeaderProps) {
  return (
...
export default WfhApplicationHeader
