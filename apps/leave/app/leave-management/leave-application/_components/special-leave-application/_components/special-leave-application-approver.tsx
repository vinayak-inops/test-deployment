...
export default function SpecialLeaveApplicationApprover({ isApprovalPermission = false }: SpecialLeaveApplicationApproverProps) {
    ...
    const collectionName = useMemo(() => {
        // Pending and Failed always use specialLeaveApplication
        if (activeTab === 'pending' || activeTab === 'failed') {
            return 'specialLeaveApplication'
        }
        // For Cancel, Reject, Approve: use specialLeaveApplicationTransaction (if exists) or specialLeaveApplication
    ...
    return (
        <div>
            <div className='px-0 py-3'>
                ...
                <p className='text-xs text-gray-500 mt-0.5'>Review and manage special leave applications assigned to you for approval</p>
            </div>
            {/* <div className='mb-3'>
