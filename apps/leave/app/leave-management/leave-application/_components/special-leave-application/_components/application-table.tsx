        ...
        <CardContent className="px-0 py-0">
          {!loading && totalItems === 0 ? (
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-sm text-muted-foreground">No special leave applications found</p>
            </div>
          ) : (
            <>
                    ...
                    {loading ? (
                      ...
                      Array.from({ length: 5 }).map((_, index) => (
                        <TableRow key={`skeleton-${index}`} className="animate-pulse">
                          ...
                          <TableCell className="px-5 py-2"><div className="h-4 bg-gray-200 rounded w-20"></div></TableCell>
                          <TableCell className="px-5 py-2"><div className="h-4 bg-gray-200 rounded w-20"></div></TableCell>
                          <TableCell className="px-5 py-2"><div className="h-6 bg-gray-200 rounded w-16"></div></TableCell>
                          <TableCell className="px-5 py-2"><div className="h-4 bg-gray-200 rounded w-20"></div></TableCell>
                          <TableCell className="px-5 py-2"><div className="h-4 bg-gray-200 rounded w-20"></div></TableCell>
                          <TableCell className="px-5 py-2"><div className="h-4 bg-gray-200 rounded w-32"></div></TableCell>
                          <TableCell className="px-5 py-2"><div className="h-7 w-7 bg-gray-200 rounded"></div></TableCell>
                        </TableRow>
                      ))
                    ) : (
