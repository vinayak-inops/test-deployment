...
export function DetailedRequestModal({ isOpen, onClose, onBack, selectedDates, currentDate, selectedLeaveType, onDateDelete, selectedEmployeeId }: DetailedRequestModalProps) {
  ...
  const { leaveCodes, loading: leaveCodesLoading, error: leaveCodesError } = useLeaveCodes("")
