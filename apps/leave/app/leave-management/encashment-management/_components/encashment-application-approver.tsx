...
interface EncashmentApplicationApproverProps {
    isApprovalPermission?: boolean
}

export default function EncashmentApplicationApprover({ isApprovalPermission: _isApprovalPermission = false }: EncashmentApplicationApproverProps) {
    ...
    const collectionName = useMemo(() => {
        // Pending and Failed always use leaveEncashmentApplication
        if (activeTab === 'pending' || activeTab === 'failed') {
            return 'leaveEncashmentApplication'
        }
        // For Cancel, Reject, Approve: use leaveEncashmentApplicationTransaction (if exists) or leaveEncashmentApplication
    ...
    return (
        <div>
            <div className='px-0 py-3'>
                ...
                <p className='text-xs text-gray-500 mt-0.5'>Review and manage encashment applications assigned to you for approval</p>
            </div>
            <ApplicationFilters
                activeTab={activeTab}
