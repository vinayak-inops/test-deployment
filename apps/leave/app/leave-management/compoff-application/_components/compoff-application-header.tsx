...
interface CompoffApplicationHeaderProps {
  title?: string;
  description?: string;
  onRefilter?: () => void;
  onAddNew?: () => void;
...
function CompoffApplicationHeader({
  title = "Comp Off Applications",
  description = "Manage and review comp off application requests",
  onRefilter,
  onAddNew,
  canAdd = true,
}: CompoffApplicationHeaderProps) {
  return (
...
export default CompoffApplicationHeader;
