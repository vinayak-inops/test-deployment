...
export default function LeaveOfAbsencePopup({ isOpen, onClose, leaveOfAbsenceApplications, initialSelectedApplication, showOnlySelected = false }: LeaveOfAbsencePopupProps) {
        ...
        <div className="px-6 pt-6 pb-6 border-b border-gray-200 bg-white">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-gray-900">
              {showOnlySelected ? "Leave of Absence Application Status" : (showStatusView ? "Leave of Absence Application Status" : "Leave of Absence Applications")}
            </h2>
