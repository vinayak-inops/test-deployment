...
const TimelineItem = ({ item, isLast, extension, reportData }: any) => {
  ...
  return (
    <div className="mb-6 relative pl-8">
      ...
      {showDetails && item.consignmentDetails && (
        <Card className="shadow-sm mt-3 p-0">
          <CardHeader className="pb-2 p-3">
            <h3 className="font-medium text-gray-800 mb-0">
              {item.consignmentDetails.event}
            </h3>
            <p className="text-xs text-gray-500 mt-0">
              {item.consignmentDetails.description}
            </p>
            <p className="text-xs text-gray-500 mt-0">
              {item.consignmentDetails.time}
            </p>
          </CardHeader>
...
// Also export as named for compatibility with different import styles
export { AutoStatusUpdate };