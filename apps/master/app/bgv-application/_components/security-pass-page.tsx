...
import BGVVerification, { BGV_URL } from "./bgv-verification";
...
export default function SecurityPassPage() {
    ...
    const viewMode = rolePermissions?.apply || false;
    ...
    useEffect(() => {
        if (rolePermissions && !(rolePermissions.apply || rolePermissions.edit || rolePermissions.add)) {
    ...
    if (isViewMode) {
        if (!viewMode) return <PageNotFound />
        return (
            <div className="">
                <FormController />
            </div>
            ...
            {employeeData && employeeData.length >= 0 && (
                <SecurityPassTable
                    ...
                    onFormView={(employee) => {
                        ...
                        router.push(`/bgv-application?mode=view&id=${encryptedData}`)
                    }}
                    onVerification={() => {
                ...
                >
                    ...
                    >
                        ...
                        <Card className="w-full h-[88vh] max-h-[90vh] flex flex-col overflow-hidden">
                            ...
                            <CardFooter className="px-6 py-3 border-t border-gray-200 justify-end gap-2">
                                <button
                                    onClick={() => setShowVerificationPopup(false)}
