...
interface EmployeeKycValidationFilterBarProps {
    searchTerm: string;
...
export default function EmployeeKycValidationFilterBar({
    searchTerm,
    setSearchTerm,
    selectedField,
    setSelectedField,
        ...
        <div className="w-full px-8 py-4 pb-0">
            <div className="max-w-7xl mx-auto flex items-center gap-4">
                ...
                <button
                    ...
                    className="px-4 py-2 h-10 text-sm font-medium text-white bg-[#6366f1] hover:bg-[#4f46e5] transition-colors rounded-lg flex-shrink-0 whitespace-nowrap"
                >
                    Filter
                </button>
