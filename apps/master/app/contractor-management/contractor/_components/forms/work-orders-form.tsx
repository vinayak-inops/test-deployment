    ...
    if (typeof sectionError === "boolean") {
      return sectionError ? (
        <SectionIncompleteNote
          ...
          description='Please fill all required fields in "Work Orders" section.'
        />
      ) : null
    }
    return (
...
export default function WorkOrdersFormWithPreview(props: any) {
  return <WorkOrdersForm {...props} />
}
