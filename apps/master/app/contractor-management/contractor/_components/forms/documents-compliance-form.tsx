...
import { DocumentsTable } from "./document/documents-table"
    ...
    if (typeof sectionError === "boolean") {
      return sectionError ? (
        <SectionIncompleteNote
          ...
          description='Please fill all required fields in "Documents & Compliance" section.'
        />
      ) : null
    }
    return (
...
export default function DocumentsComplianceFormWithPreview(props: any) {
  return <DocumentsComplianceForm {...props} />
}
