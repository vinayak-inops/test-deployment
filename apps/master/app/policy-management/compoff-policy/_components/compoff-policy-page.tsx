...
import {
  useCompOffPolicyLogic,
  FIELD_LABELS,
  type CompOffSearchField,
} from "./hooks/useCompOffPolicyLogic"
import CompOffPolicyTable from "./compoff-policy-table"
import CompOffPolicyAddPopup from "./compoff-policy-add-popup" // Import the popup component
import CompOffPolicyFormController from "./compoff-policy-form-controller" // Import the form controller
      ...
      <TableHeader
        ...
        description={
          loading || countLoading
            ? "Comp-Off Policy | Loading..."
            : `Comp-Off Policy | ${totalCount} records`
        }
        canAdd={addMode}
        onAddNew={handleAdd}
        ...
        <div className="max-w-7xl mx-auto flex items-center gap-4">
          <div className="flex bg-muted/50 rounded-lg border flex-1">
            <div className="flex items-center bg-background border-r rounded-l-lg px-3 py-2 w-52">
              <Select
                value={searchField}
                onValueChange={(v) => setSearchField(v as CompOffSearchField)}
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="compOffPolicy.compOffPolicyCode">Policy Code</SelectItem>
                  <SelectItem value="compOffPolicy.compOffPolicyTitle">Policy Title</SelectItem>
                </SelectContent>
              </Select>
            </div>
