  ...
  return (
    <div className="relative bg-white border border-gray-200 rounded-lg shadow-sm">
      ...
      <div className="px-5 py-3 border-b border-gray-100 flex items-center gap-2.5">
        ...
        <div>
          <h2 className="text-[13px] font-semibold text-gray-900 leading-none">Shift Approvers</h2>
          ...
          <div className="bg-white rounded-lg shadow-xl border border-gray-200 w-full max-w-lg">
            <div className="px-5 py-3 border-b border-gray-200 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-gray-900">Add Shift Approver</h3>
              ...
              <ActionButtons
                ...
                onPrimary={async () => {
                  if (selectedEmployee?.employeeID) {
                    ...
                    const existingApprovers = Array.isArray(base.shiftApprover)
                      ? base.shiftApprover
                      : approvers
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    const backendPayload: any = {
                      ...base,
                      shiftApprover: updatedApprovers,
                    }
