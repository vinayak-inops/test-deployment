...
interface StepLeaveApproversProps {
  approvers: string[]
...
export default function StepLeaveApprovers({
  approvers,
  onAdd,
  onRemove,
  onSave,
  ...
  const {
    ...
    onSuccess: (data) => {
      toast.success('Leave approvers updated successfully')
      onSave?.()
    },
    onError: (error) => {
      console.error('❌ Error updating leave approvers:', error)
      toast.error('Failed to update leave approvers')
    },
  })
  ...
  return (
    <div className="relative bg-white border border-gray-200 rounded-lg shadow-sm">
      ...
      <div className="px-5 py-3 border-b border-gray-100 flex items-center gap-2.5">
        ...
        <div>
          <h2 className="text-[13px] font-semibold text-gray-900 leading-none">Leave Approvers</h2>
          <p className="text-[11px] text-gray-500 mt-0.5 leading-snug">
            Select employees who can approve leave requests
          </p>
        </div>
      </div>
        ...
        {approvers.length === 0 ? (
          <div className="border rounded-lg bg-gray-50 px-6 py-10 flex flex-col items-center justify-center text-center space-y-3">
            <p className="text-sm text-gray-700 font-medium">
              No leave approvers selected.
            </p>
            <p className="text-xs text-gray-500 max-w-md">
              Use <span className="font-semibold">Add Approver</span> to choose employees who can approve leave requests.
            </p>
            <Button
              type="button"
              onClick={() => {
          ...
          <div className="bg-white rounded-lg shadow-xl border border-gray-200 w-full max-w-lg">
            <div className="px-5 py-3 border-b border-gray-200 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-gray-900">Add Leave Approver</h3>
              ...
              <ActionButtons
                ...
                onPrimary={async () => {
                  if (selectedEmployee?.employeeID) {
                    ...
                    const existingApprovers = Array.isArray(base.leaveApprover)
                      ? base.leaveApprover
                      : approvers
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    const backendPayload: any = {
                      ...base,
                      leaveApprover: updatedApprovers,
                    }
