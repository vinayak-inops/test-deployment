...
interface StepOutDutyApproversProps {
  approvers: string[]
...
export default function StepOutDutyApprovers({
  approvers,
  onAdd,
  onRemove,
  onSave,
  ...
  const {
    ...
    onSuccess: (data) => {
      toast.success('Out duty approvers updated successfully')
      onSave?.()
    },
    onError: (error) => {
      console.error('❌ Error updating out duty approvers:', error)
      toast.error('Failed to update out duty approvers')
    },
  })
  ...
  return (
    <div className="relative bg-white border border-gray-200 rounded-lg shadow-sm">
      ...
      <div className="px-5 py-3 border-b border-gray-100 flex items-center gap-2.5">
        ...
        <div>
          <h2 className="text-[13px] font-semibold text-gray-900 leading-none">Out Duty Approvers</h2>
          <p className="text-[11px] text-gray-500 mt-0.5 leading-snug">
            Select employees who can approve out duty requests
          </p>
        </div>
      </div>
        ...
        {approvers.length === 0 ? (
          <div className="border rounded-lg bg-gray-50 px-6 py-10 flex flex-col items-center justify-center text-center space-y-3">
            <p className="text-sm text-gray-700 font-medium">
              No out duty approvers selected.
            </p>
            <p className="text-xs text-gray-500 max-w-md">
              Use <span className="font-semibold">Add Approver</span> to choose employees who can approve out duty requests.
            </p>
            <Button
              type="button"
              onClick={() => {
          ...
          <div className="bg-white rounded-lg shadow-xl border border-gray-200 w-full max-w-lg">
            <div className="px-5 py-3 border-b border-gray-200 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-gray-900">Add Out Duty Approver</h3>
              ...
              <ActionButtons
                ...
                onPrimary={async () => {
                  if (selectedEmployee?.employeeID) {
                    ...
                    const existingApprovers = Array.isArray(base.outDutyApprover)
                      ? base.outDutyApprover
                      : approvers
                    const finalApprovers = Array.from(new Set([...existingApprovers, employeeID]))

                    const backendPayload: any = {
                      ...base,
                      outDutyApprover: finalApprovers,
                    }
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    const backendPayload: any = {
                      ...base,
                      outDutyApprover: updatedApprovers,
                    }
