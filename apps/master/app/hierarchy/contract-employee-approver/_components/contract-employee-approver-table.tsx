            ...
            <Table className="min-w-[1400px]">
              <TableHeader>
                <TableRow className="bg-blue-50">
                  ...
                  <TableHead className="px-5 py-2 min-w-[200px] whitespace-nowrap">Leave Approver(s)</TableHead>
                  <TableHead className="px-5 py-2 min-w-[200px] whitespace-nowrap">Punch Approver(s)</TableHead>
                  <TableHead className="px-5 py-2 min-w-[200px] whitespace-nowrap">Shift Approver(s)</TableHead>
                  <TableHead className="px-5 py-2 min-w-[200px] whitespace-nowrap">Out Duty Approver(s)</TableHead>
                ...
                {data.map((row, index) => (
                  ...
                  >
                    ...
                    <TableCell className="px-5 py-2 text-sm">
                      {formatApproverList(row.leaveApprover)}
                    </TableCell>

                    <TableCell className="px-5 py-2 text-sm">
                      {formatApproverList(row.punchApprover)}
                    </TableCell>

                    <TableCell className="px-5 py-2 text-sm">
                      {formatApproverList(row.shiftApprover)}
                    </TableCell>

                    <TableCell className="px-5 py-2 text-sm">
                      {formatApproverList(row.outDutyApprover)}
                    </TableCell>
