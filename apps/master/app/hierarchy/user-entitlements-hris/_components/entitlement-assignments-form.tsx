...
export default function EntitlementAssignmentsForm({
  ...
  const handleAddNew = () => {
    ...
    router.push('/hierarchy/user-entitlements-hris/create')
  }
  ...
  const handleView = (assignment: any) => {
    ...
    router.push(`/hierarchy/user-entitlements-hris/view?id=${assignment._id}`)
  }
  ...
  const handleEdit = (assignment: any) => {
    ...
    router.push(`/hierarchy/user-entitlements-hris/edit?id=${assignment._id}`)
  }
