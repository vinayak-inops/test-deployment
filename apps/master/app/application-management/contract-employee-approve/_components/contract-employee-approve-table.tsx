            ...
            <Table className="min-w-[900px]">
              <TableHeader>
                <TableRow className="bg-blue-50">
                  ...
                  <TableHead className="px-5 py-2 min-w-[200px] whitespace-nowrap">Contractor Code</TableHead>
              ...
              <TableBody>
                {employeeData.map((employee, index) => (
                  <TableRow key={employee._id} className="hover:bg-gray-50">
                    ...
                    <TableCell className="px-5 py-2">{employee.contractorCode || "N/A"}</TableCell>
