...
export default function EmployeeList({
  ...
  const existingApproverIds = useMemo(
    () => approvers.map((a) => a.employeeID),
    [approvers]
  )
  ...
  const queryVariables = useMemo(() => {
    const criteriaRequests: any[] = [
      ...
      { field: "employeeID", operator: "nin", value: existingApproverIds },
    ]
  ...
  }, [tenantCode, existingApproverIds, debouncedSearch, currentPage])
      ...
      <div className="bg-white rounded-lg shadow-xl border border-gray-200 w-full max-w-4xl flex flex-col max-h-[90vh] overflow-hidden">
        ...
        <div className="px-5 py-3 border-b border-gray-200 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-900">Select Contract Employees</h3>
                ...
                <Table className="min-w-[1400px]">
                  ...
                  <TableBody>
                    {searchResults.map((emp, index) => {
                      const isChecked = selectedMap.has(emp.employeeID)
                        ...
                        >
                          ...
                          >
                            <Checkbox
                              ...
                              aria-label={`Select ${emp.employeeID}`}
                            />
                          </TableCell>
        ...
        {/* Footer */}
        <div className="px-5 py-3 border-t border-gray-200 bg-gray-50 flex items-center justify-between gap-2 flex-shrink-0">
          <p className="text-[11px] text-gray-500">
            {selectedMap.size > 0 ? (
              <span className="font-semibold text-blue-600">
                {selectedMap.size} employee{selectedMap.size > 1 ? "s" : ""} selected
              </span>
            ) : (
