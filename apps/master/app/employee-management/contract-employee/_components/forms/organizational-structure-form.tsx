...
interface OrganizationalStructureFormProps {
  ...
  contractorIsLoading?: boolean
  contractorHasMore?: boolean
  onContractorLoadMore?: () => void
  onContractorSearch?: (search: string) => void
  onContractorOpen?: (open: boolean) => void
  birthDate?: string
}
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <SingleSelectField
          ...
          onLoadMore={onContractorLoadMore}
          onSearch={onContractorSearch}
          onOpenChange={onContractorOpen}
          searchDebounce={200}
        />
        )}
