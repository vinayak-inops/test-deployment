...
export default function StepPunchApprovers({
  ...
  const handleApproverSelect = async (mergedApprovers: Employee[]) => {
    ...
    const existingApprovers = Array.isArray(base.punchApprover) ? base.punchApprover : approvers
  ...
  return (
    <div className="relative bg-white border border-gray-200 rounded-lg shadow-sm">
      ...
      <div className="px-5 py-3 border-b border-gray-100 flex items-center gap-2.5">
        ...
        <div>
          <h2 className="text-[13px] font-semibold text-gray-900 leading-none">Punch Applicant</h2>
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    await postApprovers({
                      ...
                      id: base?._id || null,
                      collectionName: 'contract_employee_approver',
                      data: { punchApprover: updatedApprovers },
                    })
