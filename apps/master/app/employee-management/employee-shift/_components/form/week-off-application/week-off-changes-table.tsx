          ...
          <table className="w-full border-collapse" style={{ minWidth: "max-content", width: "100%" }}>
            ...
            <tbody>
              {employeeData.length > 0 ? (
                          ...
                          <table className="w-full border-collapse">
                            <thead>
                              <tr className="bg-gray-50 border-b border-gray-200">
                                <th className="px-3 py-1.5 text-[11px] font-semibold text-gray-600 uppercase tracking-wide text-center border-r border-gray-200">
                                  Week
                                </th>
                ...
                <tr>
                  <td colSpan={4} className="px-3 md:px-5 py-8 text-center text-sm text-gray-500">
