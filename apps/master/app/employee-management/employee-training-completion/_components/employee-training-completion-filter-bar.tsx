...
interface EmployeeTrainingCompletionFilterBarProps {
  searchTerm: string
...
export default function EmployeeTrainingCompletionFilterBar({
  searchTerm,
  setSearchTerm,
  selectedField,
  setSelectedField,
  ...
  onAddNew,
  canAdd = true
}: EmployeeTrainingCompletionFilterBarProps) {
  const selectedFieldLabel = searchFields.find(f => f.value === selectedField)?.label || ''

  return (
    <div className="w-full px-0 py-4 pb-0">
