    ...
    <div className="border-b border-gray-200 pb-6 mb-6">
      <div className="flex flex-col md:flex-row items-start md:items-end gap-6">
        <div className="flex-shrink-0">
          <h3 className="text-base font-semibold text-gray-900 mb-1">Manual Computation Period</h3>
          <p className="text-sm text-gray-500">Select the period for manual computation</p>
        </div>
