      ...
      <CardHeader className="border-b px-5 py-2 bg-gray-50/50">
        <div className="flex justify-between items-center">
          <CardTitle className="text-base font-semibold">
            Manual Computation Applications
          </CardTitle>
                  ...
                  >
                    ...
                    <TableCell className="px-5 py-2 font-medium">
                      {(() => {
                        ...
                        if (row.selectAll) {
                          const subsidiaryLabel =
                            row.subsidiary?.subsidiaryCode ||
                            row.subsidiary?.subsidiaryName ||
                            "-"
                          const divisionLabel =
                            row.division?.divisionCode || row.division?.divisionName || "-"
                          const departmentLabel =
                            row.department?.departmentCode || row.department?.departmentName || "-"
                          const subDepartmentLabel =
                            row.subDepartment?.subDepartmentCode ||
                            row.subDepartment?.subDepartmentName ||
                            "-"
                          const sectionLabel =
                            row.section?.sectionCode || row.section?.sectionName || "-"
                          ...
                          const summaryParts = [
                            ...
                            `Sub Department: ${subDepartmentLabel || "-"}`,
                            `Section: ${sectionLabel || "-"}`,
                            makeList(locations, "Locations"),
                          ]
