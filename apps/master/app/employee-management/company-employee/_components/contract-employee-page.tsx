...
export default function ContractEmployeePage() {
    ...
    const contractorEmployee = "companyEmployeeHris"
    ...
    const canAccessRequestedMode =
        (mode === "view" && viewMode) ||
        (mode === "edit" && editMode) ||
        (mode === "edit" && addMode && formMode === "temp");
    ...
    return (
        ...
        <div>
            ...
            <ContractorEmployeeHeader
                title="Employees"
                description="Manage and review employee records"
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => { if (!deleteLoading) handleCloseDelete() }}>
                    <div className=" rounded-lg p-6 max-w-md w-full mx-4" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="mb-4">
                            ...
                            Are you sure you want to delete this Company employee? This will permanently remove the record from the system.
                        </p>
                            {deleteLoading && (
