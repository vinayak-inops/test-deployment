...
function formController() {
  ...
  const { responseData: rolePermissions } = useRolePermissions({
    serviceName: "user",
    screenName: "companyEmployeeHris",
  })
  ...
  const content = (
    <div className="w-full mx-auto">
      <EmployeeShiftHeader
        ...
        description={"View and manage company employee information, including personal details, job assignments, and Company duration."}
        employeeId={headerEmployeeId || undefined}
        showBackButton={true}
        onBack={() => router.push("/employee-management/company-employee")}
        canAdd={false}
      />
