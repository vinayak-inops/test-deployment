...
interface ShiftApplicationHeaderProps {
  title?: string;
  description?: string;
  onRefilter?: () => void;
  onAddNew?: () => void;
...
function ShiftApplicationHeader({
  title = "Shift Applications",
  description = "Manage and review shift application requests",
  onRefilter,
  onAddNew,
  canAdd = true,
}: ShiftApplicationHeaderProps) {
  return (
...
export default ShiftApplicationHeader;
