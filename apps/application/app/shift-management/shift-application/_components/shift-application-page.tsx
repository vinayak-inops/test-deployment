...
import ShiftApplication from './shift-application';
import ShiftApplicationApprover from './shift-application-approver';
import { useRolePermissions } from '@/hooks/role-control/useRolePermissionsByScreenArray';
import ShiftApplicationHeader from './shift-application-header';

export default function ShiftApplicationPage() {
              ...
              {!canViewApps && !isApproverPermission && (
                <div className='px-5 py-10'>
                  <div className='max-w-2xl mx-auto text-center border border-yellow-200 bg-yellow-50 rounded-md p-6'>
                    ...
                    <p className='text-xs text-gray-600 mt-1'>You do not have permission to view Shift Applications. Please contact your administrator.</p>
                  </div>
                </div>
              )}
            </div>
