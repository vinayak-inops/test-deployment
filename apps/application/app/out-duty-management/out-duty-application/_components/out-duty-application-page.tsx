...
import OutDutyApplication from './out-duty-application';
import OutDutyApplicationApprover from './out-duty-application-approver';
import { useRolePermissions } from '@/hooks/role-control/useRolePermissionsByScreenArray';
import OutDutyApplicationHeader from './out-duty-application-header';
              ...
              {!canViewApps && !isApproverPermission && (
                <div className='px-5 py-10'>
                  <div className='max-w-2xl mx-auto text-center border border-yellow-200 bg-yellow-50 rounded-md p-6'>
                    ...
                    <p className='text-xs text-gray-600 mt-1'>You do not have permission to view Out Duty Applications. Please contact your administrator.</p>
                  </div>
                </div>
              )}
            </div>
