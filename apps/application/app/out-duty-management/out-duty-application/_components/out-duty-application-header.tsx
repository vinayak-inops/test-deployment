...
interface OutDutyApplicationHeaderProps {
  title?: string;
  description?: string;
  onRefilter?: () => void;
  onAddNew?: () => void;
...
function OutDutyApplicationHeader({
  title = "Out Duty Applications",
  description = "Manage and review out duty application requests",
  onRefilter,
  onAddNew,
  canAdd = true,
}: OutDutyApplicationHeaderProps) {
  return (
...
export default OutDutyApplicationHeader;
