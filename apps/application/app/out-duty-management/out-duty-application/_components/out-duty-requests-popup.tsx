...
export default function OutDutyRequestsPopup({ isOpen, onClose, initialSelectedRequest, selectedRequestId, isSelfPermission: _isSelfPermission = false, isAllPermission: _isAllPermission = false, userMode = 'user', sourceCollectionName, onActionSuccess, modeOfRequest }: PunchRequestsPopupProps) {
  ...
  const collectionName = useMemo(() => {
    ...
    // For user mode: always use regular collection (matching out-duty-application.tsx logic)
    ...
    >
      <div className="bg-white w-full max-w-5xl h-[85vh] flex flex-col rounded-lg shadow-2xl border border-gray-200 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-3 border-b border-gray-200">
          <h2 className="text-base font-semibold text-gray-700">Out Duty Application</h2>
              <button
                onClick={onClose}
                        ...
                        {(() => {
                          ...
                          return (
                            <div className="space-y-2">
                              ...
                              {/* From / To Durations */}
                              {(selectedRequest.fromDuration || selectedRequest.toDuration) && (
                                <div className="flex items-center border-b border-gray-100 pb-2 gap-6">
                                  <div className="flex items-center gap-2">
                                  ...
                                  <div className="flex items-center gap-2">
                                    <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider w-28 flex-shrink-0">To Duration</label>
                              ...
                              {/* Status Update Controls (respect role permissions) */}
                                {!['APPROVED', 'REJECTED', 'CANCELLED', 'FAILED'].some(status => (selectedRequest.workflowState?.toUpperCase() || '') === status) && (canApprove || canReject || canCancel) && (
      ...
      <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm">
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6 relative border border-gray-200">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500">Are you sure you want to cancel this out duty request?</p>
                        </div>
