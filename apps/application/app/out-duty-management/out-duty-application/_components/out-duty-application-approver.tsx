...
import OutDutyRequestsPopupNew from './out-duty-requests-popup';
import { useGetTenantCode } from '@/hooks/api/search/useGetTenantCode';
import { useKeyclockRoleInfo } from '@/hooks/api/search/keyclock-role-info';
import { useRolePermissions } from '@/hooks/role-control/useRolePermissionsByScreenArray';

interface OutDutyApplicationApproverProps {
    isApprovalPermission?: boolean
}

export default function OutDutyApplicationApprover({ isApprovalPermission: _isApprovalPermission = false }: OutDutyApplicationApproverProps) {
    ...
    return (
        <div>
            ...
            <ApplicationFilters
                activeTab={activeTab}
                onTabChange={(tab) => {
                    // Filter out "all" tab since approver view doesn't support it
                    if (tab !== 'all') {
