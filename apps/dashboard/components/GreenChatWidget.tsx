    ...
    >
      <div
        ...
        style={{
          ...
          background: 'var(--chat--header--background, linear-gradient(135deg, #10b981 0%, #059669 100%))',
          ...
          <div>
            ...
            <p
              style={{
                ...
                lineHeight: 'var(--chat--subtitle--line-height, 1.8)',
                opacity: 0.9,
              }}
            >
            ...
            <div
              style={{
                ...
                background: message.sender === 'user'
                  ? 'var(--chat--message--user--background, #10b981)'
          ...
          <button
            ...
            style={{
              ...
              background: !inputValue.trim() || isLoading
                ? 'var(--chat--button--background--primary--disabled, #6ee7b7)'
                : 'var(--chat--button--background--primary, #10b981)',
            ...
            onMouseEnter={(e) => {
              if (!(!inputValue.trim() || isLoading)) {
                e.currentTarget.style.background = 'var(--chat--button--background--primary--hover, #059669)';
                e.currentTarget.style.color = 'var(--chat--button--color--primary--hover, #f2f4f8)';
              }
            }}
            onMouseLeave={(e) => {
              if (!(!inputValue.trim() || isLoading)) {
                e.currentTarget.style.background = 'var(--chat--button--background--primary, #10b981)';
