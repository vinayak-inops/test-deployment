...
interface PunchApplicationHeaderProps {
  title?: string;
  description?: string;
  onRefilter?: () => void;
  onAddNew?: () => void;
...
function PunchApplicationHeader({
  title = "Punch Applications",
  description = "Manage and review punch application requests",
  onRefilter,
  onAddNew,
  canAdd = true,
}: PunchApplicationHeaderProps) {
  return (
...
export default PunchApplicationHeader;
