...
export default function EditPunchRequestsPopup({ isOpen, onClose, initialSelectedRequest, selectedRequestId, onActionSuccess, modeOfRequest }: EditPunchRequestsPopupProps) {
                ...
                <div className="max-w-2xl">
                  ...
                  <div className="space-y-2">
                    ...
                    {(() => {
                      ...
                      return !isProcessed && (canApprove || canReject || canCancel);
                    })() && (
                        ...
                        {statusAction && (
                          <button
                            ...
                            onClick={(e) => {
                              ...
                              const { id: _omitId, ...selectedRequestWithout } = selectedRequest || {};
                              const data = {
                                ...selectedRequestWithout,
                              ...
                              console.log("Prepared data for status update:", data);
